...
///
/// Print a container of elements using a custom separator,
/// and optionally a custom element getter.
///
/// Sample usage:
///
///   std::vector< int > v{ 5, 17, 6 };
///   std::cout << "v: " << join_ns::join(v, ";") << std::endl;
...
g++ -std=c++11 -D SAMPLE_JOIN -x c++ join.hpp -o sample-join
...
int main()
{
    ...
    cout << "u: " << join(vector< int >{ 5, 17, 6}, ";") << endl;
}
